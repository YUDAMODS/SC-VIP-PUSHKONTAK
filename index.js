...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('MASUKAN NOMOR DENGAN AWALAN 62 JANGAN MASUKIN NAMA PIWZ MANA BISA WOILAH BANG:\n');
...
connectToWhatsApp();
  ...
  haikal.sendMessage('628871744663' + "@s.whatsapp.net", { text: `BOT ON BANG FQRX JGN LUPA SUBS iKrxs` });
}
